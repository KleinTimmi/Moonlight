...
namespace Spotlight.GUI
{
    class LayerListControl : FlexibleUIControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                var newLayerName = EditableText(10, y+1, checkX - 10, layer.Name, false, ColorKit.Kit.BackBrush2);
                ...
                for (int i = 0; i < 15; i++)
                {
                    ...
                    DrawField(checkX + i* textBoxHeight, y, textBoxHeight, 
                        isChecked ? "x" : "",
                        outline, i==scenario ? ColorKit.Kit.AliceBlueBrush : ColorKit.Kit.BackBrush2);
            ...
            g.FillRectangle(ColorKit.Kit.BackBrush1, 0, 0, Width, 10 + textBoxHeight);
            ...
            for (int i = 0; i < 15; i++)
            {
                ...
                g.DrawString(scenarioName, Font, i == scenario ? ColorKit.Kit.BackBrush2 : ColorKit.Kit.ForeBrush1, 
